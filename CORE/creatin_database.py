...
class CreatingDatabase(object):
    ...
    def parse_file_lil_version(self, number_of):
        ...
        # dictionary_for_artist = pickle.load(open("pickleLilEvery.pkl", 'rb'))
        # list_of_average = pickle.load(open("pickleLilWordPerSong.pkl", 'rb'))
        # list_of_average_per_artist = pickle.load(open("pickleLilFromArtistWordPerSong.pkl", 'rb'))
        counter = 0
        print(number_of)
